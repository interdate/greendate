    ...
    public function postNotificationAction(Request $request)
    {
        ...
        foreach ($user->getNotifications() as $notification){
            ...
            $result[] = array(
                ...
                'date' => $notification->getDate()->format('Y/m/d'),
            );
        }
        $result = array(
            'users' => $result,
...
//                    }
    ...
    public function getFreezeAction()
    {
        ...
        return $this->view( array(
            ...
            'description' => $this->get('translator')->trans('לידיעתכם: הקפאת חשבון אינה מבטלת את המנוי בתשלום במידה ויש לכם כזה. כדי לבטל את המנוי בתשלום טרם ההקפאה יש לשלוח לנו מייל דרך עמוד צור קשר ובו בקשה לביטול המנוי בתשלום'),
