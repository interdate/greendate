...
class MessengerController extends Controller
{
    ...
    public function sendMessagesAction(Request $request)
    {
    	...
    	$message = str_replace("../../","https://www.greendate.co.il/",$message);
    	...
    	if($toUsers != false and !empty($message)){
    		...
    		foreach((array)$users as $user){
    			...
    			if($messageObj){
    				...
    				$messenger->pushNotification('קיבלת הודעה חדשה מ'. $this->getUser()->getUsername(), $contactId);
    			}
    		}
