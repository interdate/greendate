...
/**
 * Wrapper around a DQL ObjectManager.
 *
 * Provides easy to use provisioning for DQL entity users.
 *
    ...
    public function loadUserByUsername($username)
    {
        if (null !== $this->property) {
            ...
            if (!$this->repository instanceof UserProviderInterface) {
                throw new \InvalidArgumentException(sprintf('The DQL repository "%s" must implement UserProviderInterface.', get_class($this->repository)));
            }
