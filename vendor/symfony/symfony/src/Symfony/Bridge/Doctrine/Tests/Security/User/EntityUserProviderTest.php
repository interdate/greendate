...
class EntityUserProviderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testRefreshUserRequiresId()
    {
        ...
        $this->setExpectedException(
            ...
            'You cannot refresh a user from the EntityUserProvider that does not contain an identifier. The user object has to be serialized with its own identifier mapped by DQL'
        );
