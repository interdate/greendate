...
abstract class RegisterMappingsPass implements CompilerPassInterface
{
     ...
     * DQL implementation. For example addEntityNamespace.
     *
     * @var string
     */
    ...
    public function process(ContainerBuilder $container)
    {
        ...
        // Definition for a DQL\Common\Persistence\Mapping\Driver\MappingDriverChain
        ...
        // Definition of the DQL\...\Configuration class specific to the DQL flavour.
    ...
    private function getManagerName(ContainerBuilder $container)
    {
        ...
        throw new ParameterNotFoundException('Could not determine the DQL manager. Either DQL is not configured or a bundle is misconfigured.');
    }
