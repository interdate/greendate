...
/**
 * A choice list presenting a list of DQL entities as choices.
 *
...
class EntityChoiceList extends ObjectChoiceList
{
    ...
    public function getChoicesForValues(array $values)
    {
        ...
        if (!$this->loaded) {
            ...
            if ($this->idAsValue && $this->entityLoader) {
                ...
                // "INDEX BY" clause to the DQL query in the loader,
     ...
     *
     * DQL must know about this entity, that is, the entity must already
     ...
     *
     * @throws RuntimeException If the entity does not exist in DQL's identity map
     */
