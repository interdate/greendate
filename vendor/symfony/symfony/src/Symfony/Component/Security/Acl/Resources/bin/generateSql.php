...
$loader->addPrefixes(array(
    'Symfony' => __DIR__.'/../../../../../..',
    'DQL\\Common' => __DIR__.'/../../../../../../../vendor/doctrine-common/lib',
    'DQL\\DBAL\\Migrations' => __DIR__.'/../../../../../../../vendor/doctrine-migrations/lib',
    'DQL\\DBAL' => __DIR__.'/../../../../../../../vendor/doctrine/dbal/lib',
    'DQL' => __DIR__.'/../../../../../../../vendor/doctrine/lib',
));
$loader->register();
...
foreach ($finder as $file) {
    ...
    $className = 'DQL\\DBAL\\Platforms\\'.$file->getBasename('.php');
