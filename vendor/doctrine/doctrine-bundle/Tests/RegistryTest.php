...
class RegistryTest extends TestCase
{
    ...
    public function testGetUnknownConnection()
    {
        ...
        $this->setExpectedException('InvalidArgumentException', 'DQL ORM Connection named "default" does not exist.');
    ...
    public function testGetUnknownEntityManager()
    {
        ...
        $this->setExpectedException('InvalidArgumentException', 'DQL ORM Manager named "default" does not exist.');
