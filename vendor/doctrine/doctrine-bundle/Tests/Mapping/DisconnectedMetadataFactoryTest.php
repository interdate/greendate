...
class DisconnectedMetadataFactoryTest extends TestCase
{
    protected function setUp()
    {
        ...
        if (!class_exists('Doctrine\\ORM\\Version')) {
            $this->markTestSkipped('DQL ORM is not available.');
        }
    }
    ...
    public function testCannotFindNamespaceAndPathForMetadata()
    {
        ...
        $this->setExpectedException('RuntimeException', 'Can\'t find base path for "DQL\Bundle\DoctrineBundle\Tests\Mapping\DisconnectedMetadataFactoryTest');
