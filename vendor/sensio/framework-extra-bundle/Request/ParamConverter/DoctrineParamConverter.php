...
class DoctrineParamConverter implements ParamConverterInterface
{
     ...
     * {@inheritdoc}
     *
     * @throws \LogicException       When unable to guess how to get a DQL instance from the request information
    ...
    {
        // if there is no manager, this means that only DQL DBAL is configured
