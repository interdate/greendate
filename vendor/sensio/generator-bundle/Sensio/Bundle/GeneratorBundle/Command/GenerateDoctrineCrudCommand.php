...
/**
 * Generates a CRUD for a DQL entity.
 *
...
class GenerateDoctrineCrudCommand extends GenerateDoctrineCommand
{
    ...
    protected function configure()
    {
        $this
            ...
            ->setDescription('Generates a CRUD based on a DQL entity')
            ->setHelp(<<<EOT
The <info>doctrine:generate:crud</info> command generates a CRUD based on a DQL entity.
