...
/**
 * Generates a form type class for a given DQL entity.
 *
...
class GenerateDoctrineFormCommand extends GenerateDoctrineCommand
{
    ...
    protected function configure()
    {
        $this
            ...
            ->setDescription('Generates a form type class based on a DQL entity')
            ->setHelp(<<<EOT
The <info>doctrine:generate:form</info> command generates a form class based on a DQL entity.
