...
/**
 * Initializes a DQL entity inside a bundle.
 *
...
class GenerateDoctrineEntityCommand extends GenerateDoctrineCommand
{
    protected function configure()
    {
        $this
            ...
            ->setDescription('Generates a new DQL entity inside a bundle')
            ...
            ->setHelp(<<<EOT
The <info>doctrine:generate:entity</info> task generates a new DQL
