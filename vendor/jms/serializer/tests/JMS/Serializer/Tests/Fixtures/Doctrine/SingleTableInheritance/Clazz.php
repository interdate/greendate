...
class Clazz
{
    ...
    /** @ORM\ManyToOne(targetEntity = "JMS\Serializer\Tests\Fixtures\DQL\SingleTableInheritance\Teacher") */
    private $teacher;

    /** @ORM\ManyToMany(targetEntity = "JMS\Serializer\Tests\Fixtures\DQL\SingleTableInheritance\Student") */
    private $students;
