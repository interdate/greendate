...
throw new \InvalidArgumentException(sprintf('DQL %s Connection named "%s" does not exist.', $this->name, $name));
}
...
throw new \InvalidArgumentException(sprintf('DQL %s Manager named "%s" does not exist.', $this->name, $name));
}
...
throw new \LogicException('Unable to guess how to get a DQL instance from the request information.');
}
}
}
