 ...
 */
class View extends \AppBundle\Entity\View implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\View' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\View' . "\0" . 'owner', '' . "\0" . 'AppBundle\\Entity\\View' . "\0" . 'member');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (View $proxy) {
