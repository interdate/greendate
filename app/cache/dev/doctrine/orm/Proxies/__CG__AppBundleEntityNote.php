...
class Note extends \AppBundle\Entity\Note implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Note' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Note' . "\0" . 'owner', '' . "\0" . 'AppBundle\\Entity\\Note' . "\0" . 'member', '' . "\0" . 'AppBundle\\Entity\\Note' . "\0" . 'text');
        }
