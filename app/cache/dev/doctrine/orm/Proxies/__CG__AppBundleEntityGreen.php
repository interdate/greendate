 ...
 */
class Green extends \AppBundle\Entity\Green implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Green' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Green' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Green' . "\0" . 'users');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Green $proxy) {
