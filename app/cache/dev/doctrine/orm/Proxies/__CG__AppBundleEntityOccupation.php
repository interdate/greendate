 ...
 */
class Occupation extends \AppBundle\Entity\Occupation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Occupation' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Occupation' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Occupation' . "\0" . 'users');
        }
