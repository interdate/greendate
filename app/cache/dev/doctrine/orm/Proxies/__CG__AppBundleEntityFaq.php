...
class Faq extends \AppBundle\Entity\Faq implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Faq' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Faq' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Faq' . "\0" . 'content', '' . "\0" . 'AppBundle\\Entity\\Faq' . "\0" . 'isActive', '' . "\0" . 'AppBundle\\Entity\\Faq' . "\0" . 'category');
        }
