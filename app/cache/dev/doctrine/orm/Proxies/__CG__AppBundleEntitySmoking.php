 ...
 */
class Smoking extends \AppBundle\Entity\Smoking implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Smoking' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Smoking' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Smoking' . "\0" . 'users');
        }
