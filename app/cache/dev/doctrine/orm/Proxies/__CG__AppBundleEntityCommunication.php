 ...
 */
class Communication extends \AppBundle\Entity\Communication implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Communication' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Communication' . "\0" . 'owner', '' . "\0" . 'AppBundle\\Entity\\Communication' . "\0" . 'member');
        }
