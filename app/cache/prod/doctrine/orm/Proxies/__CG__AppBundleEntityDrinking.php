 ...
 */
class Drinking extends \AppBundle\Entity\Drinking implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Drinking' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Drinking' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Drinking' . "\0" . 'users');
        }
