...
class Page extends \AppBundle\Entity\Page implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Page' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Page' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Page' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Page' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Page' . "\0" . 'content', '' . "\0" . 'AppBundle\\Entity\\Page' . "\0" . 'headerType', '' . "\0" . 'AppBundle\\Entity\\Page' . "\0" . 'isActive', '' . "\0" . 'AppBundle\\Entity\\Page' . "\0" . 'uri', '' . "\0" . 'AppBundle\\Entity\\Page' . "\0" . 'footerHeader');
        }
    ...
    public function setFooterHeader(\AppBundle\Entity\FooterHeader $footerHeader = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFooterHeader', array($footerHeader));

        return parent::setFooterHeader($footerHeader);
    }
    ...
    public function getFooterHeader()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFooterHeader', array());

        return parent::getFooterHeader();
    }
