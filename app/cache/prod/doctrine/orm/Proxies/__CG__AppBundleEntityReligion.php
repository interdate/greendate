 ...
 */
class Religion extends \AppBundle\Entity\Religion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Religion' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Religion' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Religion' . "\0" . 'users');
        }
