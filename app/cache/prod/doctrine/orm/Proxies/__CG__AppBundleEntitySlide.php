...
class Slide extends \AppBundle\Entity\Slide implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Slide' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Slide' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Slide' . "\0" . 'content', '' . "\0" . 'AppBundle\\Entity\\Slide' . "\0" . 'imageName', '' . "\0" . 'AppBundle\\Entity\\Slide' . "\0" . 'isActive', '' . "\0" . 'AppBundle\\Entity\\Slide' . "\0" . 'headerType');
        }
